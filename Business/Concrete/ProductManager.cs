...
namespace Business.Concrete
{
    public class ProductManager : IProductService
    {
        ...
        {
            IResult result = BusinessRules.Run(CheckIfProductCountOfCategoryCorrect(product.CategoryId), CheckIfProductNameUnique(product.ProductName));
            if (result != null)
            {
                return result;
            }
        ...
        private IResult CheckIfProductNameUnique(string productName)
        {
            ...
            if(result)
            {
                return new ErrorResult(Messages.ProductNameNotUnique);                
            }
            return new SuccessResult();
        }
